...
## 1. Tests from the official guide, plus some extra that I wrote myself (20151211)
## 2. Tests from the pystar guide. -- These tests can be found in polls/test_polls.py
